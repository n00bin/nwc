...
| gear 441 | Arcane Conduit Seal — Pressured Muse (formerly "Demon Skull") | gear | RESOLVED 2026-07-07 (re-add locked by n00b: Demon Skull restored as gear id 7401 from baseline 420454c, with `formerId: 441` + migration notes on both entries; was INTEGRITY — BLOCKER: deleted item's id silently recycled) | n/a (integrity finding) | 2026.03.17a | 2026-07-07 |
| gear 7401 | Demon Skull (restored; formerly id 441) | gear | RESTORED 2026-07-07 (Artifact, IL2600, Power 2184/CritSev 1825/CA 2496, "Three Imps" active proc +3% DmgBonus/−3% enemy Accuracy; original intake note says screenshot-verified 2026-03-17, but no image is filed in the calibration archive — re-capture to file evidence) | none filed — needs capture for evidence | 2026.03.17a | 2026-07-07 |
