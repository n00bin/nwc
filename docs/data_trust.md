...
| power 84 | Baby Boar's Instincts | companion_powers | FIXED→CONFIRMED — was Maximum Hit Points; correct stats are Deflect + Critical Severity (0.75 each, IL 150). Renamed Boar 2026-09-12; c081 is a different companion sharing the power name, not an error. Resolves the c075/c081 conflict (c075 was right) | n00b in-game 2026-06-15 | 2026.03.17a | 2026-06-15 |
...
- ✅ **Baby Boar** (power 84) RESOLVED 2026-06-15 (n00b in-game): correct stats are **Deflect + Critical Severity** (c075 is this companion - renamed **Boar** 2026-09-12; c081 is NOT wrong, it is a DIFFERENT companion whose power shares the same display name - an augment, still unidentified, see data_issues.md). Was wrongly Maximum Hit Points; fixed.
