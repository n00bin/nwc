...
- **Proc chance measured: ~12.7% per hit** (Perfect Vision, 10 trials with an augment summoned so only the player's hits counted; 95% range 6.1-21.6%). Stored as `chanceApprox` on Perfect Vision only.
