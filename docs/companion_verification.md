...
| 34 | Bobby | **VERIFIED** off card c087; n00b confirmed Mythic base; off-scale 12,000 HP / 4.5% Defense confirmed, marked DO NOT NORMALIZE; Unflinching Will tooltip captured (dual 4.5%); Swing For the Fences IS recorded (n00b reversed); uptime **MEASURED 32%** via Test C | Mythic | Defense/Utility | Maximum Hit Points 12000, Defense 4.5% | enemy: +5% damage taken, 5s, 32% uptime (you + Bobby only) |
| 35 | Book Imp | **VERIFIED** off card c025; n00b confirmed Epic base; Celestial capture (+4.5%/+4.5%/+900 CR) independently proves the exact 1.875 rungs; power renamed to the card's spelling Bookimp's Presence; Weapon Break tooltip captured; Impish Flurry buffs the PET only, not recorded | Epic | Offense/Utility | Accuracy 1.875%, Combat Advantage 1.875% | - |
| 36 | Bruenor Battlehammer | **VERIFIED** off card c258; base corrected Mythic -> Epic (n00b: purple); Celestial capture proves the exact rungs; Stand United confirmed verbatim + does not stack; Fortification tooltip captured (split rune) | Epic | Defense | Awareness 1.875%, Defense 1.875% | party: Incoming Damage -3.0%, no stack |
| 37 | Butterfly (augment) | **VERIFIED** off card c043; base corrected Mythic -> Epic (n00b: purple) - the Mythic base was impossible, the card is an Epic copy; proc had NO ladder and printed 10% at every rarity, now 4/3 x single (5 -> 12); duplicated chance removed from the effect text; augment shares confirmed; Counteract tooltip captured | Epic | Defense | PROC (Deflect Severity 5% -> 12%, 10s) | - |
| 38 | Cambion Magus | **VERIFIED** off card c217; base corrected Common -> Rare (n00b: blue); stale note claiming NW Hub had 'corrected' the stat names DELETED - the card shows Accuracy + Critical Severity, as stored | Rare | Offense | Accuracy 1.25%, Critical Severity 1.25% | - |
| 39 | Cantankerous Mage | **VERIFIED** off card c160; n00b confirmed Uncommon (green) base; stats exact as stored; Unbridled Force gives the CA grant a confirmed 4s duration, which corroborates Aragon's 34% (implies ~12s Repel cadence) | Uncommon | Defense | Accuracy 0.75%, Defense 0.75% | enemy: grants combat advantage, 4s, 34% uptime |
| 40 | Captain Elaina Sartell | **VERIFIED** off card c091; n00b confirmed Epic (purple) base; Readiness Aura range corrected 50 -> 80 + does not stack; riposte proc given its missing ladder (3.75 -> 9) and a phantom permanent Heal And Damage stat removed; fake chance:100 dropped; Enduring Craft tooltip captured (always-on, not a proc). **Cutlass Combo's 5% CritSev + 66% uptime are sheet-sourced - Test D** | Epic | Offense/Defense | PROC (heal 3.75% -> 9% of Max HP, 10s ICD) | party: +5% Action Point Gain 80ft, no stack; Critical Severity TBD |
| 41 | Cat (augment) | **VERIFIED** off card c065; base corrected Rare -> Uncommon (n00b: green); card's 1.3% is our exact 1.25 rung; augment shares confirmed; Dulled Senses tooltip captured; stale note claiming IL 900 / +4.5% removed | Uncommon | Defense/Utility | Deflect 0.75%, Defense 0.75% | - |
| 42 | Catti-brie | **VERIFIED** off card c253; Utility slot, +1.9%/+1.9%/+375 CR = our exact 1.875 rungs, Catti-like confirmed verbatim + does not stack. **Found a NAME COLLISION**: 'Master of Craft' is two different runes; enhancement 3 corrected Critical Avoidance -> Forte and Rath Modar split onto a new record. n00b confirmed Epic (purple) base | Epic | Utility | Movement Speed 1.875%, Control Resist 1.875% | party: Movement Speed 5%, no stack |
| 43 | Cave Bear | **VERIFIED** off card c073; base corrected Legendary -> Uncommon (n00b: green) - the Legendary base was impossible, the card is an Uncommon copy; Armor Break tooltip captured; **Restoring Strikes DOES reach the player** (n00b confirmed in game), recorded as a flat +1000 Critical Avoidance while summoned - FLAT, tested green vs orange, 1000 at both | Uncommon | Offense/Utility | Maximum Hit Points 3000, Accuracy 0.75% | self: +1000 Critical Avoidance while summoned |
| 44 | Celeste | **VERIFIED** off card c153; n00b confirmed Epic (purple) base; heal proc had NO ladder and printed 7.5% at every rarity, now 2x single (7.5 / 11 / 15 / 18); fake chance:100 dropped (it is a trigger, gated by the 30s limit); Sun Burst not recorded (heal) | Epic | Utility | PROC (heal 7.5% -> 18% of Max HP, 30s cooldown) | - |
| 45 | Stalwart Golden Lion (was Celestial Lion) | **VERIFIED** off cards c013+c014; n00b confirmed the real name and Epic (purple) base. **DUPLICATE MERGED**: the same lion existed twice (ids 20 and 250); merged onto 250, orphan power 262 deleted. Proc was frozen at 3.75%, now 1x single (3.75 -> 9). **Aurulent Roar recorded** (party Radiant Weapon, 2%/stack, max 8) and **Aurulent Coalition recorded** (n00b: yes) - neither was in the data | Epic | Utility | PROC (radiant damage 3.75% -> 9%, 50%, 15s ICD) | party: Radiant Weapon stacks + 10% ally damage interception |
| 46 | Chicken (augment) | **VERIFIED** off card c055; n00b confirmed Epic (purple) base; **movement speed was wrong** (3.62 stored, card says 5.62 - same as the debuff beside it), both now on the exact 5.625 rung; proc had NO ladder, now 1.5x single (5.625 -> 13.5); fake chance:100 dropped; attacker debuff made a structured enemy effect; augment shares confirmed | Epic | Defense | PROC (Movement Speed +5.625% -> 13.5%, attacker damage -5.625% -> -13.5%, 10s, 30s cooldown) | - |
| 47 | Chultan Hunter | **VERIFIED** off card c101; n00b confirmed Epic (purple) base; fake Passive/chance-100 proc replaced with the card's plain Equip line; **10% drop bonus confirmed FLAT** in game (does not scale) - strong lead for the zone-currency family; Hunter of Chult boosts the PET's damage only, not recorded | Epic | Utility | Equip: +10% Chultan Riches / Forgotten Totems in Chult (flat) | - |
...
| 52 | Con Artist | **VERIFIED** off card c137; n00b confirmed Common (white) base - the first confirmed Common in the pass; power renamed to the card's spelling Con Artist's Discipline; proc was frozen at 9.8, now 0.13/IL (9.75 -> 117) on the exact rung; Precision tooltip captured, settling the sweep's one real ambiguity | Common | Offense | PROC (9.75 -> 117 magnitude over 4s, 10% on crit) | - |
| 53 | Crab | **VERIFIED** off card c047; n00b confirmed Epic (purple) base; proc was frozen at 1.88%, now 0.5x single (1.875 -> 4.5) on the exact rung; deflect reduction made a signed enemy debuff | Epic | Utility | PROC (root + enemy Deflect -1.875% -> -4.5%, 5s, 30s cooldown) | - |
| 54 | Crimson Crystal Golem | **VERIFIED without a card** - none exists in the archive; n00b read it in game 2026-09-13. Base corrected Common -> **Legendary** (orange), four tiers; Utility/Defense slot confirmed; Deflecting Shards wording transcribed. Shifting Shards NOT captured (n00b's call) | Legendary | Utility/Defense | Accuracy 2.75%, Combat Advantage 2.75% | - |
| 55 | Crystalline Golem | **VERIFIED** off card c195; n00b confirmed Epic (purple) base; **Max HP was a fake Passive proc** so it never scaled (7,500 at every rarity) - moved into stats[], now climbs to 18,000; Power re-based 1.9 -> exact 1.875 | Epic | Offense/Utility | Maximum Hit Points 7500, Power 1.875% | - |
...
**STORED BASE RARITY IS NOT RELIABLE - CHECK EVERY ONE.** Seven of the twenty-seven companions checked so far had the wrong starting rarity - more than one in four: Air Archon (stored Common, really Rare) and Armored Orc Wolf (stored Common, really Uncommon). Air Archon and Armored Orc Wolf were stored too LOW (Common when really Rare and Uncommon); **Deep Crow Hatchling was stored too HIGH** (Mythic when really Epic), so the error runs both ways. The archive card can never catch it - it shows an upgraded copy.
...
**TWO PREDICTIONS CONFIRMED:** `infant-gorilla` -> **Infant Gorilla** and `owlbear-cub` -> **Owlbear Cub**, both flagged from the filename before we reached the companion and both confirmed by n00b. The detector works - the remaining bolded entries are credible, not speculative.
...
**A reliable tell exists on the card.** A real augment's Enhancement line reads *"Gives an additional bonus to X, Y and Z **shared with the owner**"* (Bear Cub, Baby Bulette). A non-augment reads only *"Gives an additional bonus to Combined Rating"* - which is what Baby Boar's card says. Use that wording, not the power name, when a card is available.

This matters because the optimizer bars augments from the summoned slot by default, so a wrong flag either offers an illegal summon or forbids a legal one.
...
**SELF-AND-PET-ONLY DEBUFFS ARE IN (n00b ruling 2026-09-12, REVERSING an earlier call the same day).** n00b first said not to capture Bobby's Swing For the Fences, then reversed it. It IS recorded. A debuff that only you and your own companion benefit from still counts as a summoned bonus - the narrower audience is a reason to weight it down, not to drop it. The earlier 'self-and-pet-only debuffs are out' rule written here was my over-generalisation of a single answer and never had standing.

**Still out:** heals, shields, temporary hit points, and anything that only ever touches the PET's own stats (Book Imp's Impish Flurry, Black Ice Prospector's Mountain Hard) - those never reach the player at all.
