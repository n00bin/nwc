...
| 42 | Catti-brie | card c253 read: Utility slot, +1.9%/+1.9%/+375 CR = our exact 1.875 rungs, Catti-like confirmed verbatim + does not stack. **Found a NAME COLLISION**: 'Master of Craft' is two different runes; enhancement 3 corrected Critical Avoidance -> Forte and Rath Modar split onto a new record. **Base rarity awaiting n00b** | Epic | Utility | Movement Speed 1.875%, Control Resist 1.875% | party: Movement Speed 5%, no stack |
