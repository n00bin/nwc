...
| 34 | Bobby | **VERIFIED** off card c087; n00b confirmed Mythic base; off-scale 12,000 HP / 4.5% Defense confirmed, marked DO NOT NORMALIZE; Unflinching Will tooltip captured (dual 4.5%); Swing For the Fences IS recorded (n00b reversed) - **uptime is a borrowed placeholder, needs an in-game cooldown reading** | Mythic | Defense/Utility | Maximum Hit Points 12000, Defense 4.5% | enemy: +5% damage taken, 5s (you + Bobby only) |
