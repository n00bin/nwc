...
| 33 | Blue Fire Eye | card c229: **enhancement was WRONG** (Precision -> Perfect Vision); fake Passive proc converted to a Damage Vs Kabal stat on exact rungs (6.75 not the game's 6.8); party buff confirmed verbatim + does not stack. **Base rarity awaiting n00b** | Common | Offense | Damage Vs Kabal 0.5625% | party: Critical Strike 3.0% (no stack) |
