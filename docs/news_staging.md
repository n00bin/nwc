...
- Mekaniks: renamed the **Damage** tab to **Damage & Healing** and added a **Full Expected-Value Healing Formula** card (collapsed by default). Shows the 6-term healing formula with variable glossary, including the healer crit-severity penalty (÷2), and key insights — heals aren't reduced by defensive stats, stacking Incoming Healing on tanks multiplies your output, Power and OH should be balanced equally.
