...
### Features
- **Stable Planner — "What can I build with my insignias?"** Enter how many of each insignia type you own (just 5 numbers — Crescent / Barbed / Illuminated / Enlightened / Regal). Then each loadout gets its own **"What can I build with my insignias?"** button — click it to see which of that loadout's bonuses you can run at the same time with no insignia doing double duty, plus exactly how many more of each type you're short for the rest. No more sorting your insignia pile by hand. Saves in your browser with the rest of your loadouts.
