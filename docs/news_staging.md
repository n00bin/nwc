...
### Data
- Toon Forge: added two endgame **Combat enchantments** from in-game tooltips (both Mythic, IL 5,750). **Fluid Aurora** (healer) — +8% Overall Outgoing Healing, +9% class-resource regeneration and +9% class-resource maximum, plus an on-heal buff that grants you and your two nearest allies +4.6% Power. **Shattered Resolve** (tank) — +11% Incoming Damage Reduction, +14% Maximum HP, plus a stacking Defense/Awareness/Deflect buff (up to 5 stacks) that fires a shockwave at max stacks.
