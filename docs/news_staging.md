...
- Toon Forge: an insignia bonus on a 4-slot mount no longer switches off when you fill the 4th slot. A 3-insignia bonus stayed active with 3 insignias but went inactive the moment you slotted a 4th, even though the extra insignia just adds stats. The builder now uses the same rule as the Mounts page — the bonus stays active as long as your fixed slots feed it and any leftover insignia sits in a universal slot. The bonus picker also now offers only bonuses a mount can actually run.
