...
### Data Additions
- **103 new mount icons.** The Mounts page was missing icons for 127 mounts — 103 of them now have proper artwork, sourced from the Official Neverwinter Wiki. Coverage went from 152/279 to 255/279 mounts. The remaining 24 (no wiki icon available) are listed in `docs/mount_icons_missing.md` and need in-game captures.
