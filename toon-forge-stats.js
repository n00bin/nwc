...
const TOON_FORGE_BONUS_STATS = [
  ...
  "Incoming Damage",    // damage-taken reduction (stored negative). WIRED via DAMAGE_BUCKET_MAP/routeDamageBoost in toon-forge-engine.js → damageBoosts.incomingDamage; the tank survivability layer reads it. Listed here only for name recognition.
